...
namespace VRShooterKit.DamageSystem.Dismember
{
    public class DismemberPart : Damageable
    {
        ...
        private Rigidbody CreateBodyPart()
        {
            ...
            StartCoroutine( MoveArrowConnectionsRoutine(bodyPart) );
        ...
        private IEnumerator MoveArrowConnectionsRoutine(Rigidbody rb)
        {
            yield return new WaitForEndOfFrame();
            //move the arrows from the old bodypart to the dismenber bodypart
            ArrowConnections.MoveArrowConnections( thisRB, rb );
